...
App::App(QWidget *parent) : QWidget(parent)
{
    ...
    //animation = new JediParrot(SCREEN_WIDTH, SCREEN_HEIGHT);
    //animation = new SithParrot(SCREEN_WIDTH, SCREEN_HEIGHT);
    animation = new SaberParrot(SCREEN_WIDTH, SCREEN_HEIGHT);
